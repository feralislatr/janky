...
// Refactor redundant code into methods
// Ensure the CI/CD workflows are represented as stages/steps consistently
// Utilizes a consistent coding style and comments are applied throughout
// Identify aspects of the pipeline that are in-progress or pending
// Apply, where applicable, Jenkins Pipeline best practices
